...
Hero6.prototype.animateHeadings = function(){
  ...
  this.options.$el.find('.hero-slide:not(.Wallop-item--current) .text-content .heading, .hero-slide:not(.Wallop-item--current) .text-content .subheading').css('opacity', 0);
